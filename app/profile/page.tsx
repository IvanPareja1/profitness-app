            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <i className="ri-smartphone-line" style={{ color: '#3b82f6', fontSize: '20px' }}></i>
                  <p style={{
                    fontSize: '14px',
                    color: '#1e40af',
                    margin: 0
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <p style={{
                      ...
                      Ajusta automáticamente tu actividad laboral basándose en tus pasos diarios, tiempo activo y patrones de movimiento
                    </p>
                  </div>
                  ...
                  <div style={{
                    ...
                    <button
                      onClick={() => connectToHealthApp('apple')}
                      disabled={syncStatus === 'syncing'}
                      className="!rounded-button"
                      style={{
                        padding: '12px',
                    ...
                    >
                      <i className="ri-apple-line" style={{ fontSize: '24px', color: '#1f2937' }}></i>
                      <span style={{
                        fontSize: '12px',
                        color: '#1f2937',
                        fontWeight: '500'
                    ...
                    <button
                      onClick={() => connectToHealthApp('google')}
                      disabled={syncStatus === 'syncing'}
                      className="!rounded-button"
                      style={{
                        padding: '12px',
                    ...
                    >
                      <i className="ri-google-line" style={{ fontSize: '24px', color: '#1f2937' }}></i>
                      <span style={{
                        fontSize: '12px',
                        color: '#1f2937',
                        fontWeight: '500'
                    ...
                    <button
                      onClick={() => connectToHealthApp('samsung')}
                      disabled={syncStatus === 'syncing'}
                      className="!rounded-button"
                      style={{
                        padding: '12px',
                    ...
                    >
                      <i className="ri-smartphone-line" style={{ fontSize: '24px', color: '#1f2937' }}></i>
                      <span style={{
                        fontSize: '12px',
                        color: '#1f2937',
                        fontWeight: '500'
                    ...
                    <button
                      onClick={() => connectToHealthApp('fitbit')}
                      disabled={syncStatus === 'syncing'}
                      className="!rounded-button"
                      style={{
                        padding: '12px',
                    ...
                    >
                      <i className="ri-heart-pulse-line" style={{ fontSize: '24px', color: '#1f2937' }}></i>
                      <span style={{
                        fontSize: '12px',
                        color: '#1f2937',
                        fontWeight: '500'
